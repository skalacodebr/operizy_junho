...
class CustomerLoginController extends Controller
{
    ...
    public function showLoginForm($slug)
    {
        ...
        if (Utility::CustomerAuthCheck($slug) == true){
            ...
            return view('storefront.' . $store->theme_dir . '.auth.login', compact('blog','total_item', 'store', 'slug', 'page_slug_urls', 'privacyPage', 'termsPage'));
    ...
    public function login(Request $request, $slug, $cart = 0)
   {
    ...
    public function profile($slug, $id)
    {
        ...
        return view('storefront.customer.profile', compact('blog', 'slug', 'store', 'page_slug_urls', 'userDetail'));
