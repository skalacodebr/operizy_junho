                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        {{ Form::textarea('topbar_notification_msg',$settings['topbar_notification_msg'], ['class' => 'form-control summernote-simple', 'required' => 'required']) }}
                                    </div>

                                </div>
                            </div>
                            <div class="card-footer {{ isset($site_settings['SITE_RTL']) && $site_settings['SITE_RTL'] == 'on' ? 'text-start':'text-end' }}">
