                    ...
                    <ul class="navbar-nav">
                        ...
                        @if (is_array(json_decode($settings['menubar_page'])) || is_object(json_decode($settings['menubar_page'])))
                            @foreach (json_decode($settings['menubar_page']) as $key => $value)
                                @if ($value->header == 'on')
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ (isset($value->template_name) && $value->template_name == 'page_content') ? route('custom.page',$value->page_slug) :  $value->page_url }}">{{ $value->menubar_page_name }}</a>
                                    </li>
                                @endif
                            @endforeach
                        @endif
                                ...
                                <div class="col-12">
                                    <div class="bg-primary p-4 rounded">
                                        <div class="row gy-3 align-items-center">
                                            ...
                                            <div class="col-xxl-6 col-lg-6">
                                            <div class="d-flex align-items-center gap-3 justify-content-center @if($SITE_RTL == 'on') justify-content-sm-start @else justify-content-sm-end @endif">
                                                <div class="text-end">
