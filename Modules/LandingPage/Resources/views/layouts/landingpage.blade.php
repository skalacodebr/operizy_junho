                    ...
                    <div class="col-xxl-4 col-md-6">
                        ...
                        <div class="d-flex gap-3 mt-4 banner-btn">
                            @if ($settings['home_live_demo_link'])
                                <a href="{{ $settings['home_live_demo_link'] }}" class="btn btn-outline-dark">{{ __('Live Demo') }} <i
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card price-card shadow-none {{ $key == 2 ? 'bg-dark' : ""  }}">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled my-3">
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->enable_custdomain =='on' ? __('Enable') : __('Disable') }}
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->enable_custsubdomain =='on' ? __('Enable') : __('Disable') }} {{ __('Sub Domain') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->shipping_method =='on' ? __('Enable') : __('Disable') }} {{ __('Shipping Method') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->additional_page =='on' ? __('Enable') : __('Disable') }}
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->blog =='on' ? __('Enable') : __('Disable') }} {{ __('Blog') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->pwa_store =='on' ? __('Enable') : __('Disable') }} {{ __('Progressive Web App (PWA)') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->enable_chatgpt == 'on' ? __('Enable') : __('Disable') }} {{ __('Chatgpt') }}</label>
                                        </div>
                                    </li>
                                ...
                                <div class="d-grid">
                                    @if(\Auth::user())
                                        <a href="{{ route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($value->id)) }}" class="btn btn-primary rounded-pill">{{ __('Start with ') . $value->name }} <i data-feather="log-in" class="ms-2"></i> </a>
                                    @else
                                        <a href="{{ route('register', ['plan' => \Illuminate\Support\Facades\Crypt::encrypt($value->id)]) }}" class="btn btn-primary rounded-pill">{{ __('Start with ') . $value->name }} <i data-feather="log-in" class="ms-2"></i> </a>
                                    @endif
                                </div>
                            </div>
                        </div>
