...
$('body').on('click', '.overlay, .menu-close-icon .close-menu', function (e) {
 ...
 $('.acnav-label').click(function () {
    ...
    function responsiveMenu() {
        if ($(window).width() < 992) {
            if (!$('.mobile-lag').length) {
                const newDiv = document.createElement('div');
                newDiv.className = 'mobile-lag flex align-center';
                $(newDiv).insertAfter('.menu-close-icon');
                $('.header-select-wrp').prependTo('.mobile-lag');
            }
        } else {
            $('.header-style-one .header-select-wrp').prependTo('.header-style-one .menu-item-right');
            $('.mobile-lag').remove();
        }
    }
    $(document).ready(function () {
   ...
   /*********  Header Search Popup  ********/
    ...
    $(".about-info-slider").slick({
     ...
     /*** about-info-slider js ***/
     var prevArrow = '<div class="slick-prev product-left"><svg width="69" height="24" viewBox="0 0 69 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.939339 10.9393C0.353554 11.5251 0.353554 12.4749 0.939339 13.0607L10.4853 22.6066C11.0711 23.1924 12.0208 23.1924 12.6066 22.6066C13.1924 22.0208 13.1924 21.0711 12.6066 20.4853L4.12132 12L12.6066 3.51471C13.1924 2.92893 13.1924 1.97918 12.6066 1.39339C12.0208 0.807606 11.0711 0.807606 10.4853 1.39339L0.939339 10.9393ZM69 10.5L2 10.5L2 13.5L69 13.5L69 10.5Z" fill="#222222"/></svg></div>';
     var nextArrow = '<div class="slick-next product-right"><svg width="69" height="24" viewBox="0 0 69 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M68.0607 13.0607C68.6464 12.4749 68.6464 11.5251 68.0607 10.9393L58.5147 1.3934C57.9289 0.807611 56.9792 0.807611 56.3934 1.3934C55.8076 1.97919 55.8076 2.92893 56.3934 3.51472L64.8787 12L56.3934 20.4853C55.8076 21.0711 55.8076 22.0208 56.3934 22.6066C56.9792 23.1924 57.9289 23.1924 58.5147 22.6066L68.0607 13.0607ZM0 13.5H67V10.5H0V13.5Z" fill="#222222"/></svg></div>'
    if ($('.delight-product-slider').length > 0) {
    $(".delight-product-slider").slick({
        slidesToShow: 1,       
        slidesToScroll: 1,
        arrows: true,
        rtl:true,
...
var prevArrow = '<div class="slick-prev testimonial-left"><svg width="69" height="24" viewBox="0 0 69 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.939339 10.9393C0.353554 11.5251 0.353554 12.4749 0.939339 13.0607L10.4853 22.6066C11.0711 23.1924 12.0208 23.1924 12.6066 22.6066C13.1924 22.0208 13.1924 21.0711 12.6066 20.4853L4.12132 12L12.6066 3.51471C13.1924 2.92893 13.1924 1.97918 12.6066 1.39339C12.0208 0.807606 11.0711 0.807606 10.4853 1.39339L0.939339 10.9393ZM69 10.5L2 10.5L2 13.5L69 13.5L69 10.5Z" fill="#222222"/></svg></div>';
var nextArrow = '<div class="slick-next testimonial-right"><svg width="69" height="24" viewBox="0 0 69 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M68.0607 13.0607C68.6464 12.4749 68.6464 11.5251 68.0607 10.9393L58.5147 1.3934C57.9289 0.807611 56.9792 0.807611 56.3934 1.3934C55.8076 1.97919 55.8076 2.92893 56.3934 3.51472L64.8787 12L56.3934 20.4853C55.8076 21.0711 55.8076 22.0208 56.3934 22.6066C56.9792 23.1924 57.9289 23.1924 58.5147 22.6066L68.0607 13.0607ZM0 13.5H67V10.5H0V13.5Z" fill="#222222"/></svg></div>'
if ($('.testimonial-main-slider').length > 0) {
...
/** PDP slider **/
    ...
    // Reinitialize the thumbnail slider
    ...
    function () {
      ...
      if (!$this.hasClass("active")) {
        $this.closest(".tabs-wrapper")
          .find("ul.tabs li, .category-img-wrp")
          .removeClass("active");
        $('.category-img-wrp[id="' + $theTab + '"]').addClass("active");
        $('ul.tabs li[data-tab="' + $theTab + '"]').addClass("active");
      }
    },
    function () {
      var $this = $(this);
      var $theTab = $this.attr("data-tab");
      if (!$this.hasClass("active")) {
        $('.category-img-wrp').removeClass("active");
