...
<div id="invoice-POS" style="width:100%">
    ...
    <div id="bot">
        <div id="table">
            <table>
                <tr class="tabletitle">
                    <td class="item"><h2>{{__('Item')}}</h2></td>
                    <td class="Hours" style="text-align: center"><h2>{{__('Qty')}}</h2></td>
                    <td class="Rate"><h2>{{__('Price')}}</h2></td>
                </tr>
    ...
    <div class="footer pt-2">
        <center><p class="text-dark p-2">{{__('Merchandise may not be returned for refund at any time. Power bases cannot be exchanged and are non-refundable. For purchases made in a Milo Showroom, no refunds are available and sales c')}}</p></center>
    </div>
</div>
<script>
    window.print();
