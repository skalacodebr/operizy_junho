                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade active show" id="pills-header" role="tabpanel" aria-labelledby="pills-header">
                            ...
                            <div class="row">
                                ...
                                @if ($theme == 'theme1' || $theme == 'theme6' || $theme == 'theme10')   {{-- || $theme == 'theme7' || $theme == 'theme8' || $theme == 'theme9' --}}
                                    @php
                                    ...
                                    @if ($section['section_name'] == 'Banner-Image')
                                        ...
                                        <div class="col-lg-6">
                                            @if ($json_key == 0 || ($json_key - 1 > -1 && $getStoreThemeSetting[$json_key - 1]['section_slug'] != $section['section_slug']))
                                                <div class="d-flex mb-3 align-items-center justify-content-between">
                                                    <h4 class="mb-0">{{ __($section['section_name']) }} </h4>
                                                    <div class="form-check form-switch custom-switch-v1">
                                                        <input type="hidden"
                                                            ...
                                                            @foreach ($section['inner-list'] as $inner_list_key => $field)
                                                                ...
                                                                @if ($field['field_type'] == 'text')
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="form-label">{{ __($field['field_name']) }}</label>
                                                                            @php
                                                                            ...
                                                                            @if ($section['array_type'] == 'multi-inner-list')
                                                                                <input type="text"
                                                                                    ...
                                                                                    class="form-control"
                                                                                    value="{{ $checked1 }}"
                                                                                    placeholder="{{ __($field['field_help_text']) }}">
                                                                            @else
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if ($section['array_type'] == 'multi-inner-list')
                                                                                <textarea name="array[{{ $json_key }}][{{ $field['field_slug'] }}][{{ $i }}]" id=""
                                                                                    class="form-control" rows="3" placeholder="{{ __($field['field_help_text']) }}">{{ $checked1 }}</textarea>
                                                                            @else
                                                                                <textarea name="array[{{ $json_key }}][inner-list][{{ $inner_list_key }}][field_default_text]" id=""
                                                                                    class="form-control" rows="3" placeholder="{{ __($field['field_help_text']) }}">{{ $field['field_default_text'] }}</textarea>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                                @if ($field['field_type'] == 'photo upload')
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        @else
                                                                            ...
                                                                            @endphp
                                                                            <div class="form-group">
                                                                                <label class="form-label">{{ __($field['field_name']) }}</label>
                                                                            ...
                                                                            <img src="{{ $imgdisplay }}{{ $field['field_default_text'] }} "
                                                                                ...
                                                                                class="img_setting mb-image border border-2 border-primary rounded {{ $field['field_slug'] == 'homepage-category-tag-image' ? 'homepage-category-tag-image' : '' }}"
                                                                    ...
                                                                    @if ($field['field_type'] == 'photo upload')
                                                                        <div class="col-md-6">
                                                                            @if ($section['array_type'] == 'multi-inner-list')
                                                                                ...
                                                                                @if (isset($checked2) && !is_array($checked2))
                                                                                    <img src="{{ asset(Storage::url('uploads/' . $checked2)) }}" class=" mb-image border border-2 border-primary rounded"
                                                                                        style="width: auto; max-height: 80px;">
                                                                                @else
                                                                                    <img src="{{ $imgdisplay }}{{ $field['field_default_text'] }}" class=" mb-image border border-2 border-primary rounded"
                                                                                        style="width: auto; max-height: 80px;">
                                                                                @endif
                                                                            @else
                                                                                @php
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        class="form-label">{{ __($field['field_name']) }}</label>
                                                                                        <input type="hidden" name="array[{{ $json_key }}][inner-list][{{ $inner_list_key }}][field_prev_text]" value="{{ $field['field_default_text'] }}">
                                                                                    <input type="file" name="array[{{ $json_key }}][inner-list][{{ $inner_list_key }}][field_default_text]" class="form-control" placeholder="{{ __($field['field_help_text']) }}">
                                                                                </div>
                                                                                <img src="{{ $imgdisplay }}{{ $field['field_default_text'] }} "
                                                                                    id="{{ $field['field_slug'] == 'header-tag' || $field['field_slug'] == 'product-header-tag' || $field['field_slug'] == 'tag-image' || $field['field_slug'] == 'homepage-footer-logo8' || $field['field_slug'] == 'homepage-category-tag-image' ? 'shadow-img' : '' }}"
                                                                                    class="img_setting mb-image border border-2 border-primary rounded {{ $field['field_slug'] == 'homepage-category-tag-image' ? 'homepage-category-tag-image' : '' }}"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if ($section['array_type'] == 'multi-inner-list')
                                                                                ...
                                                                                rows="3" placeholder="{{ __($field['field_help_text']) }}">{{ $checked1 }}</textarea>
                                                                            @else
                                                                                <textarea name="array[{{ $json_key }}][inner-list][{{ $inner_list_key }}][field_default_text]" id=""
                                                                                    class="form-control" rows="3" placeholder="{{ __($field['field_help_text']) }}">{{ $field['field_default_text'] }}</textarea>
                                                                            @endif
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="form-check form-switch custom-switch-v1">
                                                                            <label class="form-check-label"
                                                                                for="array[ {{ $section['section_slug'] }}][{{ $field['field_slug'] }}]">{{ __($field['field_name']) }}</label>
                                                                            @if ($section['array_type'] == 'multi-inner-list')
                                                                                @php
                                                                                    $checked1 = '';
                                                                            ...
                                                                            <div class="px-3 py-3">
                                                                                <div class="row align-items-center">
                                                                                    ...
                                                                                    <div class="col-auto actions">
                                                                                        <a class="action-item btn btn-sm btn-icon bg-secondary text-white"
                                                                                    ...
                                                                                    <div class="col-auto actions">
                                                                                        <a name="deleteRecord"
                                                                                            class="action-item deleteRecord btn btn-sm bg-icon bg-danger text-white me-2"
                                                            ...
                                                            @if ($field['field_type'] == 'photo upload')
                                                                <div class="col-md-6">
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <img src="{{ $imgdisplay }}{{ $field['field_default_text'] }} "
                                                                            id="{{ $field['field_slug'] == 'header-tag' || $field['field_slug'] == 'product-header-tag' || $field['field_slug'] == 'tag-image' || $field['field_slug'] == 'homepage-footer-logo8' || $field['field_slug'] == 'homepage-category-tag-image' ? 'shadow-img' : '' }}"
                                                                            class="img_setting {{ $field['field_slug'] == 'homepage-category-tag-image' ? 'homepage-category-tag-image' : '' }}"
                                                                            @if (!empty($getStoreThemeSetting['dashboard'])) style=""
                                                                            @else
                                                                            style="width: auto; height: 50px;" @endif
                                                                            @if ($field['field_slug'] == 'homepage-footer-logo') style="width: auto; height: 80px;"
