                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-user-1" role="tabpanel"
                        ...
                        <div class="d-flex justify-content-between action-btn-wrapper">
                            ...
                            @can('Create Location')
                                <a class="btn btn-sm btn-icon  btn-primary text-white" data-url="{{ route('location.create') }}" data-title="{{ __('Create New Location') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create New Location') }}">
                    ...
                    <div class="tab-pane fade" id="pills-user-2" role="tabpanel" aria-labelledby="pills-user-tab-2">
                        <div class="d-flex justify-content-between action-btn-wrapper">
                            ...
                            @can('Create Shipping')
                                <a class="btn btn-sm btn-icon  btn-primary text-white" data-url="{{ route('shipping.create') }}" data-title="{{ __('Create New Shipping') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create New Shipping') }}">
                                    <i  data-feather="plus"></i>
                                </a>
                            @endcan
                        </div>
