...
<div class="action-btn-wrapper">
    @can('Create Coupans')
        <a class="btn btn-sm btn-icon  btn-primary text-white" data-url="{{ route('coupons.create') }}" data-title="{{ __('Add Coupon') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create') }}">
