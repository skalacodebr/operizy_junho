    ...
    <div class="row">
            ...
            <div class="card h-100">
                <div class="card-header border-0 pb-0">
                    <h6 class="card-title mb-0">
                        ...
                        Informações Frete Grátis
                    </h6>
                </div>
                <div class="card-body">
                    <p class="text-muted mb-3">Cadastre as informações e configurações do Frete Grátis.</p>
                    ...
                    <div class="alert alert-primary border-0" role="alert">
                        ...
                        <div class="mt-2" id="resumoFreteGratis">
                            <ul class="list-unstyled mb-0 mt-2">
                                <li class="mb-1">
                                    <i class="ti ti-percentage text-muted me-1"></i>
                                    <span class="text-secondary" id="resumoDesconto">00,00% de desconto</span>
                                </li>
                                <li class="mb-1">
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- Toggle Ativar Frete Grátis -->
                    <div class="toggle-section">
                        <label class="custom-toggle">
                            <input type="checkbox" id="ativarFreteGratis" checked>
                            <span class="toggle-slider"></span>
                        </label>
                        <span class="toggle-status">SIM</span>
                        <span class="toggle-label">Ativar frete grátis</span>
                    </div>
                    
                    <!-- Descrição do Cupom -->
                    <div class="form-group">
                        <label for="descricaoCupom" class="form-label">Descrição do Cupom</label>
                        <input type="text" class="form-control" id="descricaoCupom" placeholder="Ex: Cupom de fim de ano">
                    </div>
                    
                    <!-- Tipo de Desconto -->
                    <div class="form-group">
                        <label class="form-label">Tipo de Desconto</label>
                        <div class="btn-group w-100 mb-3" role="group" aria-label="Tipo de desconto">
                            <input type="radio" class="btn-check" name="tipoDesconto" id="porcentagem" value="porcentagem" checked>
                            <label class="btn btn-outline-primary" for="porcentagem">Porcentagem (%)</label>
                            
                            <input type="radio" class="btn-check" name="tipoDesconto" id="valorFixo" value="valor_fixo">
                            <label class="btn btn-outline-secondary" for="valorFixo">Valor fixo (R$)</label>
                        </div>
                    </div>
                    
                    <!-- Campo de Porcentagem -->
                    <div class="form-group mb-0" id="campoPorcentagem">
                        <label for="porcentagemDesconto" class="form-label">Porcentagem</label>
                        <div class="input-group">
                            <span class="input-group-text">%</span>
                            <input type="number" class="form-control" id="porcentagemDesconto" placeholder="0" value="0" min="0" max="100" step="0.01">
                        </div>
                    </div>
                    
                    <!-- Campo de Valor Fixo (inicialmente oculto) -->
                    <div class="form-group mb-0" id="campoValorFixo" style="display: none;">
                        <label for="valorFixoDesconto" class="form-label">Valor fixo</label>
                        <div class="input-group">
                            <span class="input-group-text">R$</span>
                            <input type="number" class="form-control" id="valorFixoDesconto" placeholder="0,00" step="0.01" min="0">
                        </div>
                    </div>
                </div>
            </div>
            
            <!-- Card: Condições de Aplicação -->
            <div class="card mb-4">
                <div class="card-header">
                    <h6 class="card-title mb-0">
                        <i class="ti ti-target text-primary me-2"></i>
                        Aplicar desconto quando o produto atingir:
                    </h6>
                </div>
                <div class="card-body">
                    <!-- Opções de aplicação -->
                    <div class="form-group mb-3">
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="radio" name="condicaoAplicacao" id="sempreAplicar" value="sempre">
                            <label class="form-check-label" for="sempreAplicar">
                                Sempre aplicar o desconto
                            </label>
                        </div>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="radio" name="condicaoAplicacao" id="valorMinimo" value="valor_minimo" checked>
                            <label class="form-check-label" for="valorMinimo">
                                Valor mínimo do produto
                            </label>
                        </div>
                        <div class="form-check mb-0">
                            <input class="form-check-input" type="radio" name="condicaoAplicacao" id="quantidadeMinima" value="quantidade_minima">
                            <label class="form-check-label" for="quantidadeMinima">
                                Quantidade mínima de produtos
                            </label>
                        </div>
                    </div>
                    
                    <!-- Campo Valor Mínimo do Produto -->
                    <div class="form-group mb-0" id="campoValorMinimoProduto" style="display: block;">
                        <label for="valorMinimoProduto" class="form-label">Valor mínimo do produto</label>
                        <div class="input-group">
                            <span class="input-group-text">R$</span>
                            <input type="number" class="form-control" id="valorMinimoProduto" placeholder="00,00" step="0.01" min="0" value="">
                        </div>
                    </div>
                    
                    <!-- Campo Quantidade Mínima (inicialmente oculto) -->
                    <div class="form-group mb-0" id="campoQuantidadeMinima" style="display: none;">
                        <label for="quantidadeMinimaProdutos" class="form-label">Quantidade mínima de produtos</label>
                        <div class="input-group">
                            <span class="input-group-text">#</span>
                            <input type="number" class="form-control" id="quantidadeMinimaProdutos" placeholder="0" min="1" value="1">
...
$(document).ready(function() {
    ...
    $('#ativarFreteGratis').change(function() {
    ...
    $('input[name="tipoDesconto"]').change(function() {
        ...
        if (tipoSelecionado === 'porcentagem') {
            ...
            $('#porcentagem').next('label').removeClass('btn-outline-primary').addClass('btn-outline-primary')
                .css({'background-color': '#8B5CF6', 'border-color': '#8B5CF6', 'color': 'white'});
            $('#valorFixo').next('label').removeClass('btn-outline-primary').addClass('btn-outline-secondary')
            ...
            // Atualizar estilos dos botões
            $('#valorFixo').next('label').removeClass('btn-outline-secondary').addClass('btn-outline-primary')
                .css({'background-color': '#8B5CF6', 'border-color': '#8B5CF6', 'color': 'white'});
            $('#porcentagem').next('label').removeClass('btn-outline-primary').addClass('btn-outline-secondary')
                .css({'background-color': '', 'border-color': '', 'color': ''});
        }
        updateResumo();
    });
    ...
    // Função para atualizar resumo do Frete Grátis
    function updateResumo() {
        const ativo = $('#ativarFreteGratis').is(':checked');
        ...
        if (tipoDesconto === 'porcentagem') {
            $('#resumoDesconto').text(`${porcentagem.toFixed(2).replace('.', ',')}% de desconto no frete`);
        } else {
            $('#resumoDesconto').text(`R$ ${valorFixo.toFixed(2).replace('.', ',')} de desconto no frete`);
        }
        
        // Atualizar condição de aplicação baseado na seleção
        const condicaoAplicacao = $('input[name="condicaoAplicacao"]:checked').val();
        const valorMinimoProduto = parseFloat($('#valorMinimoProduto').val()) || 0;
        const quantidadeMinima = parseInt($('#quantidadeMinimaProdutos').val()) || 1;
        
        if (condicaoAplicacao === 'sempre') {
            $('#resumoCompraMinima').text('Aplicado sempre em qualquer produto');
        } else if (condicaoAplicacao === 'valor_minimo') {
            $('#resumoCompraMinima').text(`Produto deve custar pelo menos R$ ${valorMinimoProduto.toFixed(2).replace('.', ',')}`);
        } else if (condicaoAplicacao === 'quantidade_minima') {
            $('#resumoCompraMinima').text(`Mínimo de ${quantidadeMinima} ${quantidadeMinima === 1 ? 'produto' : 'produtos'} no carrinho`);
        } else {
            $('#resumoCompraMinima').text('Condição de aplicação não definida');
        }
        ...
        const resumoContainer = $('#resumoFreteGratis');
        if (!ativo) {
...
function salvarDesconto() {
    ...
    const dados = {
        ativo: $('#ativarFreteGratis').is(':checked'),
        descricaoCupom: $('#descricaoCupom').val(),
        tipoDesconto: $('input[name="tipoDesconto"]:checked').val(),
        porcentagemDesconto: $('#porcentagemDesconto').val() || null,
        valorFixoDesconto: $('#valorFixoDesconto').val() || null,
        condicaoAplicacao: $('input[name="condicaoAplicacao"]:checked').val(),
        valorMinimoProduto: $('#valorMinimoProduto').val() || null,
        quantidadeMinimaProdutos: $('#quantidadeMinimaProdutos').val() || null,
    ...
    if (!dados.descricaoCupom.trim()) {
        Swal.fire({
            icon: 'warning',
            title: 'Descrição obrigatória',
            text: 'Por favor, informe a descrição do cupom.',
            confirmButtonColor: '#fb6c2b'
        });
        $('#descricaoCupom').focus();
        return;
    }
    
    // Validar campos de desconto
    if (dados.tipoDesconto === 'porcentagem' && (!dados.porcentagemDesconto || dados.porcentagemDesconto <= 0)) {
        Swal.fire({
            icon: 'warning',
            title: 'Porcentagem obrigatória',
            text: 'Por favor, informe uma porcentagem de desconto válida.',
            confirmButtonColor: '#fb6c2b'
        });
    ...
    if (dados.tipoDesconto === 'valor_fixo' && (!dados.valorFixoDesconto || dados.valorFixoDesconto <= 0)) {
        Swal.fire({
            icon: 'warning',
            title: 'Valor fixo obrigatório',
            text: 'Por favor, informe um valor fixo de desconto válido.',
            confirmButtonColor: '#fb6c2b'
        });
    ...
    if (dados.condicaoAplicacao === 'valor_minimo' && (!dados.valorMinimoProduto || dados.valorMinimoProduto <= 0)) {
        Swal.fire({
            icon: 'warning',
            title: 'Valor mínimo obrigatório',
            text: 'Por favor, informe um valor mínimo do produto válido.',
            confirmButtonColor: '#fb6c2b'
        });
        $('#valorMinimoProduto').focus();
        return;
    }
    
    if (dados.condicaoAplicacao === 'quantidade_minima' && (!dados.quantidadeMinimaProdutos || dados.quantidadeMinimaProdutos <= 0)) {
        Swal.fire({
            icon: 'warning',
            title: 'Quantidade mínima obrigatória',
            text: 'Por favor, informe uma quantidade mínima de produtos válida.',
            confirmButtonColor: '#fb6c2b'
        });
        $('#quantidadeMinimaProdutos').focus();
        return;
    }
    ...
    if (dados.limitarData && (!dados.dataInicio || !dados.dataFim)) {
        Swal.fire({
            ...
            text: 'Por favor, informe as datas de início e fim quando limitar por data.',
            confirmButtonColor: '#fb6c2b'
        });
        return;
    }
    
    if (!dados.todosProdutos && dados.produtosSelecionados.length === 0) {
        Swal.fire({
            icon: 'warning',
    ...
    Swal.fire({
        title: 'Salvando...',
        text: 'Salvando desconto progressivo, aguarde...',
        icon: 'info',
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.sucesso) {
                Swal.fire({
                    icon: 'success',
                    title: 'Sucesso!',
                    text: response.mensagem || 'Desconto Progressivo salvo com sucesso!',
                    confirmButtonColor: '#28a745',
                    timer: 3000,
                    timerProgressBar: true,
                    willClose: () => {
                    ...
                    // Se o usuário clicar em OK antes do timer
                ...
                console.log('Desconto progressivo salvo:', response.dados);
                
            } else {
                let mensagemErro = response.erro || 'Erro ao salvar desconto progressivo';
        ...
        error: function(xhr, status, error) {
            ...
            let mensagemErro = 'Erro ao salvar desconto progressivo';
        ...
        complete: function() {
            // Sempre executado no final, independente de sucesso ou erro
