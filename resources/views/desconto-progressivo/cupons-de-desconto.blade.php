    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">Cadastre as informações e configurações do cupom.</p>
                    ...
                    <div class="alert alert-primary border-0" role="alert">
                        ...
                        <div class="mt-2" id="resumoBrinde">
                            <ul class="mb-0">
                                <li>10.00% de desconto</li>
                                <li>Limite de 1 utilização</li>
                                <li>Utilização única por cliente</li>
                                <li>Qualquer cliente pode utilizar</li>
                                <li>Válida a partir de 25/05/2023</li>
                            </ul>
                        </div>
                    </div>
                </div>
