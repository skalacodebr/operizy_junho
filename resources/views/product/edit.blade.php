...
@php
    ...
    $downloadable_prodcut_image = \App\Models\Utility::get_file('uploads/downloadable_prodcut/');
                        ...
                        <div class=" col-lg-6 col-md-6">
                            ...
                            <div class="card shadow-none border border-primary">
                                <div class="card-body ">
                                            ...
                                            <div class="row gy-3 gx-3">
                                                <div class="col-sm-6">
                                                    <div class="position-relative p-2 border rounded border-primary overflow-hidden rounded">
                                                        <img src="{{ $is_cover_image . $product->attachment }}" alt="" class="w-100">
                                                        <div class="position-absolute text-center top-50 end-0 start-0 pb-3">
                                                            <a href="{{ $is_cover_image . $product->attachment }}" class="btn btn-sm btn-primary me-2" data-bs-placement="top"  data-bs-toggle="tooltip" title="{{ __('Download') }}"><i class="ti ti-download"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @if(!empty($product->downloadable_prodcut))
                                        <div class="form-group">
                                            <div class="row gy-3 gx-3">
                                                <div class="col-sm-6">
                                                    <div class="position-relative p-2 border rounded border-primary overflow-hidden rounded">
                                                        <img src="{{ $downloadable_prodcut_image . $product->downloadable_prodcut }}" alt="" class="w-100">
                                                        <div class="position-absolute text-center top-50 end-0 start-0 pb-3">
                                                            <a href="{{ $downloadable_prodcut_image . $product->downloadable_prodcut }}" class="btn btn-sm btn-primary me-2" data-bs-placement="top"  data-bs-toggle="tooltip" title="{{ __('Download') }}"><i class="ti ti-download"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
