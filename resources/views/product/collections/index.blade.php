...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block text-white font-weight-bold mb-0">{{ __('Collections') }}</h5>
    </div>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Collections') }}</li>
@endsection
                            ...
                            <tbody>
                                @foreach ($collections as $collection)
                                    <tr>
                                        ...
                                        <td class="Action">
                                            <div class="d-flex">
                                                <a href="{{ route('product.collections.edit', $collection->id) }}" class="btn btn-sm btn-icon bg-light-secondary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Edit') }}">
