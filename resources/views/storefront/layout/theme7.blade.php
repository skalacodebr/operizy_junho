...
@php
    ...
    $brand_logo = \App\Models\Utility::get_file('uploads/theme7/brand_logo/');
                ...
                <div class="footer-row flex">
                    <div class="footer-col">
                        <div class="footer-widget set has-children1">
                            ...
                            <p>{{ $getStoreThemeSetting[7]['inner-list'][1]['field_default_text'] }}</p>
                            @if (Utility::CustomerAuthCheck($store->slug) == true)
                                ...
                                <div class="footer-col footer-link">
                                    <div class="footer-widget set has-children1">
                                        <h2 class="footer-acnav">
                                            <span>{{ __($getStoreThemeSetting[8]['inner-list'][1]['field_default_text']) }}</span>
                                        ...
                                        <ul class="footer-acnav-list">
                                            ...
                                            @else
                                                @for ($i = 0; $i < $getStoreThemeSetting[9]['loop_number']; $i++)
                                                    <li>
                                                        <a href="{{ $getStoreThemeSetting[9]['inner-list'][1]['field_default_text'] }}">
                                                            {{ $getStoreThemeSetting[9]['inner-list'][0]['field_default_text'] }}</a>
                                                    </li>
                                                @endfor
                                            @endif
                                        </ul>
                        ...
                        @if ($getStoreThemeSetting[10]['inner-list'][0]['field_default_text'] == 'on')
                            @if ((isset($getStoreThemeSetting[10]['section_enable']) && $getStoreThemeSetting[10]['section_enable'] == 'on') || $getStoreThemeSetting[10]['inner-list'][1]['field_default_text'])
                                <div class="footer-col footer-link">
                                    <div class="footer-widget set has-children1">
                                        <h2 class="footer-acnav">
                                            <span>{{ __($getStoreThemeSetting[10]['inner-list'][1]['field_default_text']) }}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 10 5" width="10"
                                                height="5">
                                                <path class="a"
                                                    d="m5.4 5.1q-0.3 0-0.5-0.2l-3.7-3.7c-0.3-0.3-0.3-0.7 0-1 0.2-0.3 0.7-0.3 0.9 0l3.3 3.2 3.2-3.2c0.2-0.3 0.7-0.3 0.9 0 0.3 0.3 0.3 0.7 0 1l-3.7 3.7q-0.2 0.2-0.4 0.2z">
                        ...
                        @if ($getStoreThemeSetting[12]['inner-list'][1]['field_default_text'] == 'on')
                            @if ((isset($getStoreThemeSetting[12]['section_enable']) && $getStoreThemeSetting[12]['section_enable'] == 'on') || $getStoreThemeSetting[12]['inner-list'][1]['field_default_text'])
                                <div class="footer-col footer-link">
                                    <div class="footer-widget set has-children1">
                                        <h2 class="footer-acnav">
                                            <span>{{ __($getStoreThemeSetting[12]['inner-list'][0]['field_default_text']) }}</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 10 5" width="10"
                                                height="5">
                                                <path class="a"
                                                    d="m5.4 5.1q-0.3 0-0.5-0.2l-3.7-3.7c-0.3-0.3-0.3-0.7 0-1 0.2-0.3 0.7-0.3 0.9 0l3.3 3.2 3.2-3.2c0.2-0.3 0.7-0.3 0.9 0 0.3 0.3 0.3 0.7 0 1l-3.7 3.7q-0.2 0.2-0.4 0.2z">
                                        ...
                                        <ul class="footer-acnav-list">
                                            ...
                                            @else
                                                @for ($i = 0; $i < $getStoreThemeSetting[13]['loop_number']; $i++)
                                                    <li>
                                                        <a
                                                            href="{{ $getStoreThemeSetting[13]['inner-list'][1]['field_default_text'] }}">{{ $getStoreThemeSetting[13]['inner-list'][0]['field_default_text'] }}
                                                        </a>
                                                    </li>
                                                @endfor
                                            @endif
                    ...
                    @foreach ($getStoreThemeSetting as $storethemesetting)
                        @if (isset($storethemesetting['section_name']) &&
                            ...
                            <div class="footer-col footer-link footer-subscribe-col">
                                <div class="footer-widget set has-children1">
                                    <h2 class="footer-acnav">
                                        <span>{{ !empty($SubscriberTitle) ? $SubscriberTitle : __('Subscribe') }}</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 10 5" width="10"
                                            height="5">
                                            <path class="a"
                                                d="m5.4 5.1q-0.3 0-0.5-0.2l-3.7-3.7c-0.3-0.3-0.3-0.7 0-1 0.2-0.3 0.7-0.3 0.9 0l3.3 3.2 3.2-3.2c0.2-0.3 0.7-0.3 0.9 0 0.3 0.3 0.3 0.7 0 1l-3.7 3.7q-0.2 0.2-0.4 0.2z">
                                    ...
                                    <div class="footer-acnav-list">
                                        <p>{{ !empty($SubscriberDescription) ? $SubscriberDescription : __('Subscribe to us and stay up to date with the information') }}</p>
                                        {{ Form::open(['route' => ['subscriptions.store_email', $store->id], 'method' => 'POST', 'class' => 'subscribe-form-wrapper']) }}
                                            <div class="input-wrapper flex">
                                                ...
                                                <button type="submit" class="subscribe-btn btn">
                                                    <span>{{ !empty($SubscribeButton) ? $SubscribeButton : __('SUBSCRIBE') }}</span>
