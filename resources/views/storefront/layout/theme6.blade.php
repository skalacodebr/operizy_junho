...
@php
    ...
    $brand_logo = \App\Models\Utility::get_file('uploads/theme6/brand_logo/');
                        ...
                        <div class="footer-col contact-col">
                            <div class="footer-widget set has-children1">
                                <div class="footer-logo">
                                    <a href="{{ route('store.slug', $store->slug) }}">
                                        <img src="{{ $imgpath . $getStoreThemeSetting[6]['inner-list'][0]['field_default_text'] }}" alt="">
                                    </a>
                                </div>
                                ...
                                @if ($theme['field_name'] == 'Enable Quick Link 1')
                                    @if ($getStoreThemeSetting[7]['inner-list'][0]['field_default_text'] == 'on')
                                        @if (!empty($getStoreThemeSetting[7]))
                                            @if ((isset($getStoreThemeSetting[7]['section_enable']) &&
                                                $getStoreThemeSetting[7]['section_enable'] == 'on') ||
                                                ...
                                                <div class="footer-col footer-link">
                                                    <div class="footer-widget set has-children1">
                                                        ...
                                                        <ul class="footer-acnav-list">
                                                            @if (isset($getStoreThemeSetting[8]['homepage-header-quick-link-name-1'],$getStoreThemeSetting[8]['homepage-header-quick-link-1']))
                                    ...
                                    @if ($getStoreThemeSetting[9]['inner-list'][0]['field_default_text'] == 'on')
                                        @if (!empty($getStoreThemeSetting[9]))
                                            @if ((isset($getStoreThemeSetting[9]['section_enable']) &&
                                                $getStoreThemeSetting[9]['section_enable'] == 'on') ||
                            ...
                            @else
                                @for ($i = 0; $i < $getStoreThemeSetting[14]['loop_number']; $i++)
                                    @if (isset($getStoreThemeSetting[14]['inner-list'][1]['field_default_text']) &&
                                        isset($getStoreThemeSetting[14]['inner-list'][0]['field_default_text']))
                                            <li>
                                                <a href="{{ $getStoreThemeSetting[14]['inner-list'][1]['field_default_text'] }}" target="_blank" class="flex align-center justify-center">
