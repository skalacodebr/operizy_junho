@php
    ...
    $brand_logo = \App\Models\Utility::get_file('uploads/theme2/brand_logo/');
                    ...
                    <div class="logo-col">
                        <h1>
                            <a href="{{ route('store.slug', $store->slug) }}">
                                <img src="{{ (!empty($store->logo) ? $s_logo . $store->logo : ($brand_logo . 'brand_logo.png')) . '?timestamp='. time() }}" alt="logo" loading="lazy">
                            </a>
                        </h1>
                    </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="footer-bottom-inner flex align-center justify-between">
                        @if ($getStoreThemeSetting[13]['section_enable'] == 'on')
                            <p>{{ $getStoreThemeSetting[13]['inner-list'][0]['field_default_text'] }}</p>
                        @endif
                            ...
                            @else
                                @for ($i = 0; $i < $getStoreThemeSetting[14]['loop_number']; $i++)
                                    @if (isset($getStoreThemeSetting[14]['inner-list'][1]['field_default_text']) &&
                                            isset($getStoreThemeSetting[14]['inner-list'][0]['field_default_text']))
                                        <li>
                                            <a href="{{ $getStoreThemeSetting[14]['inner-list'][1]['field_default_text'] }}" target="_blank"
                                            class="flex align-center justify-center">
