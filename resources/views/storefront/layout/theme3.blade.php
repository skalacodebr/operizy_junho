...
@php
    ...
    $brand_logo = \App\Models\Utility::get_file('uploads/theme3/brand_logo/');
...
<body class="{{ !empty($themeClass) ? $themeClass : 'theme3-v1' }}">
                    ...
                    <div class="menu-item-right flex align-center justify-end">
                        ...
                        <div class="header-select-wrp flex align-center">
                            ...
                            <div class="profile-header">
                                ...
                                @else
                                    <a href="{{ route('customer.login', $store->slug) }}" class="btn acnav-label">
                                        <span>{{ __('Log in') }}</span>
                                    </a>
                                @endif
                            </div>
    ...
    <footer class="site-footer">
                ...
                <div class="container">
                    <div class="footer-col flex justify-center text-center">
                        <div class="footer-logo">
                            <a href="{{ route('store.slug', $store->slug) }}">
                                <img src="{{ $imgpath . $getStoreThemeSetting[4]['inner-list'][0]['field_default_text'] }}" alt="logo" loading="lazy">
                            </a>
                        </div>
                        <ul class="footer-acnav-list flex align-center justify-center">
                            @if (
                                !empty($getStoreThemeSetting[5]['inner-list'][0]['field_default_text']) &&
                                    $getStoreThemeSetting[5]['inner-list'][0]['field_default_text'] == 'on')
                                @if (isset($getStoreThemeSetting[6]['homepage-header-quick-link-name-1']) ||
                                        isset($getStoreThemeSetting[6]['homepage-header-quick-link-1']))
                                    <li><a href="{{ $getStoreThemeSetting[6]['homepage-header-quick-link-1'][0] }}">
                                            {{ $getStoreThemeSetting[6]['homepage-header-quick-link-name-1'][0] }}</a>
                                    </li>
                                @else
                                    <li><a href="{{ $getStoreThemeSetting[6]['inner-list'][1]['field_default_text'] }}">
                                        {{ $getStoreThemeSetting[6]['inner-list'][0]['field_default_text'] }}</a>
                                    </li>
                                @endif
                            @endif

                            @if (
                                !empty($getStoreThemeSetting[7]['inner-list'][0]['field_default_text']) &&
                                    $getStoreThemeSetting[7]['inner-list'][0]['field_default_text'] == 'on')
                                @if (isset($getStoreThemeSetting[8]['homepage-header-quick-link-name-2']) ||
                                        isset($getStoreThemeSetting[8]['homepage-header-quick-link-2']))
                                    <li><a href="{{ $getStoreThemeSetting[8]['homepage-header-quick-link-2'][0] }}">
                                            {{ $getStoreThemeSetting[8]['homepage-header-quick-link-name-2'][0] }}</a>
                                    </li>
                                @else
                                    <li><a href="{{ $getStoreThemeSetting[8]['inner-list'][1]['field_default_text'] }}">
                                            {{ $getStoreThemeSetting[8]['inner-list'][0]['field_default_text'] }}</a>
                                    </li>
                                @endif
                            @endif

                            @if (
                                !empty($getStoreThemeSetting[9]['inner-list'][0]['field_default_text']) &&
                                    $getStoreThemeSetting[9]['inner-list'][0]['field_default_text'] == 'on')
                                @if (isset($getStoreThemeSetting[10]['homepage-header-quick-link-name-3']) ||
                                        isset($getStoreThemeSetting[10]['homepage-header-quick-link-3']))
                                    <li><a href="{{ $getStoreThemeSetting[10]['homepage-header-quick-link-3'][0] }}">{{ $getStoreThemeSetting[10]['homepage-header-quick-link-name-3'][0] }}</a>
                                    </li>
                                @else
                                    <li><a href="{{ $getStoreThemeSetting[10]['inner-list'][1]['field_default_text'] }}">
                            ...
                            @if (
                                !empty($getStoreThemeSetting[11]['inner-list'][0]['field_default_text']) &&
                                    $getStoreThemeSetting[11]['inner-list'][0]['field_default_text'] == 'on')
                                @if (isset($getStoreThemeSetting[12]['homepage-header-quick-link-name-4']) ||
                                        isset($getStoreThemeSetting[12]['homepage-header-quick-link-4']))
                                    <li><a href="{{ $getStoreThemeSetting[12]['homepage-header-quick-link-4'][0] }}">
                                            {{ $getStoreThemeSetting[12]['homepage-header-quick-link-name-4'][0] }}</a>
                                    </li>
                                @else
                                    <li><a href="{{ $getStoreThemeSetting[12]['inner-list'][1]['field_default_text'] }}">
                                            {{ $getStoreThemeSetting[12]['inner-list'][0]['field_default_text'] }}</a>
                                    </li>
                                @endif
                            @endif
                        </ul>
                        @if ($getStoreThemeSetting[13]['section_enable'] == 'on')
                            <ul class="footer-social-icon flex align-center justify-center">
                                @if (isset($getStoreThemeSetting[13]['homepage-footer-2-social-icon']) ||
                                        isset($getStoreThemeSetting[13]['homepage-footer-2-social-link']))
                                    @if (isset($getStoreThemeSetting[13]['inner-list'][1]['field_default_text']) &&
                                            isset($getStoreThemeSetting[13]['inner-list'][0]['field_default_text']))
                                        @foreach ($getStoreThemeSetting[13]['homepage-footer-2-social-icon'] as $icon_key => $storethemesettingicon)
                                            @foreach ($getStoreThemeSetting[13]['homepage-footer-2-social-link'] as $link_key => $storethemesettinglink)
                                                @if ($icon_key == $link_key)
                                                    <li><a href="{{ $storethemesettinglink }}" class="flex align-center justify-center"
                                ...
                                @else
                                    @for ($i = 0; $i < $getStoreThemeSetting[13]['loop_number']; $i++)
                                        @if (isset($getStoreThemeSetting[13]['inner-list'][1]['field_default_text']) &&
                                                isset($getStoreThemeSetting[13]['inner-list'][0]['field_default_text']))
                                            <li><a href="{{ $getStoreThemeSetting[13]['inner-list'][1]['field_default_text'] }}" class="flex align-center justify-center"
                                                    target="_blank">{!! $getStoreThemeSetting[13]['inner-list'][0]['field_default_text'] !!}</a></li>
                                        @endif
                                    @endfor
                                @endif
                            </ul>
        ...
        @endif
        @if (isset($getStoreThemeSetting[13]['section_enable']) && $getStoreThemeSetting[13]['section_enable'] == 'on')
