                                ...
                                <div class="product-card-inner">
                                    <div class="product-card-image">
                                        ...
                                        <div class="pro-btn-wrapper">
                                            <div class="pro-btn">
                                                <a href="javascript:void(0)" id="delete_wishlist_item1" tabindex="0" class="wishlist-btn wishlist-active heart-btn delete_wishlist_item" data-id="{{$product['product_id']}}">
                                        ...
                                        <div class="product-content-bottom">
                                            <div class="price">
                                                ...
                                                @else
                                                    ...
                                                    <del>{{ \App\Models\Utility::priceFormat($product['last_price'] ?? 0) }}</del>
                                                @endif
                                            </div>
