                                    ...
                                    <div class="product-card-image">
                                        <a href="{{ route('store.product.product_view', [$store->slug, $product['product_id']]) }}" class="default-img img-wrapper">
                                            @if (!empty($product['image']))
                                                <img src="{{ $imgpath . $product['image'] }}" alt="product-card-image">
                                            @else
                                                <img alt="product-card-image"
                                                    src="{{ asset(Storage::url('uploads/is_cover_image/default.jpg')) }}">
                                            @endif
                                        </a>
                                        <a href="{{ route('store.product.product_view', [$store->slug, $product['product_id']]) }}" class="hover-img img-wrapper">
                                            @if (!empty($product['product_image']))
                                                <img src="{{ $imgpath2 . $product['product_image'] }}" alt="product-card-image">
                                        ...
                                        <div class="pro-btn-wrapper ">
                                            <div class="pro-btn">
                                                <a href="javascript:void(0)" id="delete_wishlist_item1" data-id="{{ $product['product_id'] }}" class="wishlist-btn btn wishlist-active heart-icon action-item wishlist-icon bg-light-gray delete_wishlist_item">
                                            ...
                                            <div class="pro-btn">
                                                @if ($product['enable_product_variant'] == 'on')
                                                    <a href="{{ route('store.product.product_view', [$store->slug, $product['product_id']]) }}" class="compare-btn btn cart-btn">
                                                ...
                                                @else
                                                    <a data-id="{{ $product['product_id'] }}" class="compare-btn btn cart-btn add_to_cart">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M5.19086 6.37945C5.00086 6.37945 4.80086 6.29945 4.66086 6.15945C4.37086 5.86945 4.37086 5.38945 4.66086 5.09945L8.29086 1.46945C8.58086 1.17945 9.06086 1.17945 9.35086 1.46945C9.64086 1.75945 9.64086 2.23945 9.35086 2.52945L5.72086 6.15945C5.57086 6.29945 5.38086 6.37945 5.19086 6.37945Z"
