...
<main>
    ...
    <section class="pdp-page-main-sec pt pb">
        <div class="container">
            <div class="row">
                    ...
                    <div class="pdp-left-column sticky-column">
                        <div class="pdp-slider-wrapper">
                            ...
                            <div class="pro-thumb-slider">
                                @foreach ($products_image as $key => $productss)
                                    <div class="thumb-image" data-slide-to="{{ $key }}">
    ...
    <section class="pdp-tab-sec tabs-wrapper pb">
        <div class="container">
            <div class="tab-head-row">
                <ul class="tabs flex no-wrap align-center justify-center">
                    <li data-tab="pdp-tab-1" class="active">
                        <a href="javascript:;">{{ __('Information') }}</a>
                    </li>
