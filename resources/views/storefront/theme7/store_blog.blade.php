                                ...
                                <div class="blog-card-image">
                                    <a href="{{ route('store.store_blog_view', [$store->slug, $blog->id]) }}" class="blog-image img-ratio">
                                        @if(!empty($blog->blog_cover_image) )
                                            <img src="{{ $imgpath . $blog->blog_cover_image }}" alt="blog-card-image" loading="lazy">
                                        @else
                                            <img src="{{ asset(Storage::url('uploads/store_logo/default.jpg')) }}" alt="blog-card-image" loading="lazy">
                                        @endif
                                    </a>
                                </div>
