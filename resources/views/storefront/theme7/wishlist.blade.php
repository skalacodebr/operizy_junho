                                ...
                                <div class="product-card-inner">
                                    <div class="product-card-image">
                                        ...
                                        <div class="pro-btn-wrapper">
                                            <div class="pro-btn">
                                                <a href="javascript:void(0)" id="delete_wishlist_item1" class="wishlist-btn btn wishlist-active btn heart-btn delete_wishlist_item" data-id="{{$product['product_id']}}">
