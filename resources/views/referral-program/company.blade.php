            ...
            <div class="card-body">
                <div class="row row-gap align-items-center">
                    <div class="col-lg-6 col-md-6 col-12 ">
                        <div class = "border rounded border-2 p-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="#!" class="btn btn-sm btn-light-primary w-100 cp_link"
                                ...
                                data-bs-original-title="Click to copy referral link">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($transaction->status == 0)
                                                <span
                                                    class="status_badge badge bg-light-danger border border-1 border-danger common-lbl-radius p-2 px-3 tbl-btn-w">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                            @elseif($transaction->status == 1)
                                                <span
                                                    class="status_badge badge bg-light-warning border border-1 border-warning common-lbl-radius p-2 px-3 tbl-btn-w">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                            @elseif($transaction->status == 2)
                                                <span
                                                    class="status_badge badge bg-light-primary border border-1 border-primary common-lbl-radius p-2 px-3 tbl-btn-w">{{ __(\App\Models\ReferralTransactionOrder::$status[$transaction->status]) }}</span>
                                            @endif
                                        </td>
